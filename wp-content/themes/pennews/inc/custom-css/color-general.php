...
function penci_customizer_color_general() {
	...
	if ( $color_links ) {
		...
		$css .= 'div.wpforms-container .wpforms-form input[type=date],';
		$css .= 'div.wpforms-container .wpforms-form input[type=datetime],';
		$css .= 'div.wpforms-container .wpforms-form input[type=datetime-local],';
		$css .= 'div.wpforms-container .wpforms-form input[type=email],';
		$css .= 'div.wpforms-container .wpforms-form input[type=month],';
		$css .= 'div.wpforms-container .wpforms-form input[type=number],';
		$css .= 'div.wpforms-container .wpforms-form input[type=password],';
		$css .= 'div.wpforms-container .wpforms-form input[type=range],';
		$css .= 'div.wpforms-container .wpforms-form input[type=search],';
		$css .= 'div.wpforms-container .wpforms-form input[type=tel],';
		$css .= 'div.wpforms-container .wpforms-form input[type=text],';
		$css .= 'div.wpforms-container .wpforms-form input[type=time],';
		$css .= 'div.wpforms-container .wpforms-form input[type=url],';
		$css .= 'div.wpforms-container .wpforms-form input[type=week],';
		$css .= 'div.wpforms-container .wpforms-form select,';
		$css .= 'div.wpforms-container .wpforms-form textarea{ color: ' . esc_attr( $color_links )  . ' }';
	...
	if ( $color_border ) {
		...
		$css .= 'div.wpforms-container .wpforms-form input[type=week],';
		$css .= 'div.wpforms-container .wpforms-form select,';
		$css .= 'div.wpforms-container .wpforms-form textarea{ border-color: ' . esc_attr( $color_border )  . ' }';
	...
	if ( $color_accent ) {
		...
		$css .= 'div.wpforms-container .wpforms-form input[type=submit]:hover,';
		$css .= 'div.wpforms-container .wpforms-form button[type=submit]:hover,';
		$css .= 'div.wpforms-container .wpforms-form .wpforms-page-button:hover,';
		$css .= 'div.wpforms-container .wpforms-form .wpforms-page-button:hover,';
