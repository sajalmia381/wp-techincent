...
$general_extra_check = array(
	...
	'penci_use_fpost_featured_img'   => esc_html__( 'Replace  The First Image From a Post', 'pennews' ),
	'penci_dis_block_pagination'     => esc_html__( 'Disable pagination block with page Fullwidth', 'pennews' ),
	'penci_dis_query_cache'          => esc_html__( 'Disable query cache', 'pennews' ),
	'penci_fontawesome_ver5'         => esc_html__( 'Use Fontawesome Version 5', 'pennews' ),
);
...
$general_extra_check2 = array(
	...
	'penci_dis_countview_module' => esc_html__( 'Hide Post Count Views', 'pennews' ),
	'penci_hide_pennew_panel'    => esc_html__( 'Hide PenNews Panel on Dashboard for Administrator', 'pennews' ),
	'penci_use_tagline_h1'       => esc_html__( 'Use Tagline To H1 On Your Home Page', 'pennews' ),
);
