...
if ( !class_exists( 'Penci_Social_Share' ) ):
	class Penci_Social_Share {
		...
		public static function get_link_share_post( $social_key, $link, $text = '', $img_link = '' ) {
			$array_numbers = array( '|', '&', '%', '#038;',';','’','#8211','#8212','#8216','#8217','#8218','#8220','#8221','#8222','#8224','#8225','#8226','#8230','#8240','#8364','#8482' );
			$array_number_replace = array( '-', '-', '', '', '','','','','','','','','','','','','','','','','' );
			$text = str_replace( $array_numbers, $array_number_replace, $text );
