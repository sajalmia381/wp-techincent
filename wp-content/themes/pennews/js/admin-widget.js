	...
	PENCIWIDGETS.widgetImg = function () {
		...
		$( 'body' ).on( 'click', '.penci-tab-widget a', function ( e ) {
			...
			var $this = $( this ),
				...
				$wpmmwidgetContent = $( this ).closest( '.wpmm_widget-content' ),
				$wpmmtabContent = $wpmmwidgetContent.find( '.tab-content' );;
			...
			$wpmmtabContent.not( tab ).css( 'display', 'none' );
			$wpmmwidgetContent.find( tab ).fadeIn();
