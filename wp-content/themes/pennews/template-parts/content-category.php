...
$option_layout_id = 'penci_cat_layout_style';

$archive_layout = get_query_var( 'penci_acsb_layout_style' );

if( is_home() || is_front_page() ) {
	$archive_layout = penci_get_setting( 'penci_home_layout_style' );
}elseif ( is_category() ) {
	$archive_layout = penci_get_taxomony_layout_style( 'category' );
}elseif ( is_tag() ) {
