	...
	<div class="penci-author-content penci_mobj__body">
		...
		<div class="author-socials">
			...
			<?php if ( get_the_author_meta( 'linkedin' ) ) : ?>
				<a target="_blank"<?php echo penci_get_rel_noopener(); ?> class="author-social" href="https://www.linkedin.com/<?php echo esc_attr( the_author_meta( 'linkedin' ) ); ?>"><i class="fa fa-linkedin"></i></a>
			<?php endif; ?>
