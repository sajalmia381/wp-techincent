...
$featured_image_size = penci_single_optimize_featured_img_size( 'style-1'  );
...
$post_thumb_url      = penci_post_formats( $featured_image_size, false, false, 'style-1' );
?>
			...
			<div class="penci-wide-content penci-content-novc penci-sticky-content penci-content-single-inner">
				<div class="theiaStickySidebar">
					...
					while ( have_posts() ) : the_post();
						...
						?>
						<article id="post-<?php the_ID(); ?>" <?php post_class( 'penci-single-artcontent noloaddisqus' ); ?>>
