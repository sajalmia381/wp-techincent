			...
			<div class="penci_media_object">
				<div class="penci-post-header penci-featured-col-1">
					...
					<div class="penci-ad-box">
						<?php
						$header_ad_box      = penci_get_theme_mod( 'penci_single_header_ad_box' );
				...
				<div class="penci-featured-col-2 penci_mobj__body">
					<?php
					$featured_image_size = penci_single_optimize_featured_img_size( 'style-10' );
					...
					penci_post_formats( $featured_image_size, true, ! $dis_jarallax );
					?>
				</div>
			</div>
		</div>
