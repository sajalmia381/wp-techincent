...
<div class="penci-container">
	<?php if ( ! $single_hide_img && $post_thumb_url ): ?>
		<div class="entry-media penci-entry-media penci-entry-media-top <?php Penci_Video_Format::get_class_type_video( get_the_ID() ); ?>">
	...
	<?php endif; ?>
	<div class="penci-container__content<?php penci_class_pos_sidebar_content(); ?> noloaddisqus <?php echo esc_attr( ! $single_hide_img && $post_thumb_url ? '' : 'hide_featured_image' ); ?>" data-url="<?php the_permalink() ?>" data-id="<?php the_ID(); ?>" data-title="<?php get_the_guid(); ?>">
