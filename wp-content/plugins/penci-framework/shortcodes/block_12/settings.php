<?php
$shotcode_id = 'block_12';

// Shortcode settings
return array(
	'name'   => esc_html__( 'Block 12', 'penci-framework' ),
	'weight' => 878,
	'params' => array_merge(
		...
		Penci_Framework_Shortcode_Params::block_option_meta( array( 'cat', 'comment', 'date','icon_post_format','view','review','author','read_more' ), array( 'view' ) ),
