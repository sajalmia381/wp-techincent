...
$general = array(
	array(
		...
		'options'    => array(
			...
			'style-28' => PENCI_ADDONS_URL . 'assets/img/slider/style-28.png',
		),
		'admin_label' => true,
	),
	array(
	...
	array(
		'type'             => 'penci_number',
		'param_name'       => 'fea_item_s28width',
		'heading'          => esc_html__( 'Custom  Width Each Item for Featured Slider Style 28', 'penci-framework' ),
		'value'            => '',
		'std'              => '',
		'suffix'           => 'px',
		'min'              => 1
...
return array(
	...
	'params' =>array_merge(
		...
		Penci_Framework_Shortcode_Params::block_option_meta( array( 'date','cat', 'comment', 'view','hide_dis_bg_block' ),array( 'author' ) ),
		array(
			array(
				'type'             => 'checkbox',
			...
			array(
				'type'             => 'checkbox',
				'heading'          => esc_html__( 'Move Slider Content to Above Images for Featured Slider Style 17', 'penci-framework' ),
				'param_name'       => '_content_above',
				'edit_field_class' => 'vc_col-sm-6',
			),
			array(
				'type'        => 'dropdown',
