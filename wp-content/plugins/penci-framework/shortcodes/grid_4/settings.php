...
// Shortcode settings
return array(
	'name'   => esc_html__( 'Big Grid 4', 'penci-framework' ),
	'weight' => 848,
	'params' => array_merge(
		...
		Penci_Framework_Shortcode_Params::block_option_meta( array( 'comment', 'date','icon_post_format','review' ), array( 'author','view' ) ),
