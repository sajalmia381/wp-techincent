...
$post_placeholder  = 3 - intval( $query_cat_grid->post_count );
?>
	<div class="penci-category-grid penci-catgrid-s10">
		<div class="penci-container">
			<div class="penci-div-inner">
				...
				while ( $query_cat_grid->have_posts() ) :
					...
					if ( $bgrid_count == 3 || $cat_grid_i == $query_cat_grid->post_count ) {
						if( $post_placeholder ) {
