...
?>
	<div class="penci-category-grid penci-catgrid-s9">
			...
			<div class="penci-div-inner">
				<div class="penci-pitems-wrap clearfix">
					...
					while ( $query_cat_grid->have_posts() ) :
						...
						if( 3 == $cat_grid_i ){
							echo '<div class="penci-pitem-smalls">';
						}
						...
						if ( $bgrid_count == 4 || $cat_grid_i == $query_cat_grid->post_count ) {
							if ( $post_placeholder ) {
								for ( $i = 1; $i <= $post_placeholder; $i ++ ) {
									...
									?>
									<article <?php post_class( 'penci-post-item ' . ( 3 > $cat_grid_i2 ? 'penci-pitem-big' : 'penci-pitem-small'  ) . ' penci-pitem-placeholder penci-pitem-' . $cat_grid_i2 ); ?>>
										<?php
										echo Penci_Helper_Shortcode::get_image_holder_pre( array(
											'hide_review' => true,
										) );
